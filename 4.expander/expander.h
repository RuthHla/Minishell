...
/*   Updated: 2025/09/26 14:50:54 by alandel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void						copy_value(char *expanded, int *exp_idx,
								char *value);
...
int							extract_variable_pos(char *str, t_var_pos *var,
								int start, int j);
int							process_dollar_pos(char *str, int i,
								t_var_pos *var);
t_var_pos					*find_variables_with_positions(char *str,
								int *count);
